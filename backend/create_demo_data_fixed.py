#!/usr/bin/env python3
"""
Create comprehensive demo data for demo@eliteher.com user covering last year.
...
def generate_yearly_cycles() -> list:
    ...
    # Create a realistic pattern for year
    cycle_lengths = []
...
def create_demo_user_with_year_data():
    ...
    try:
        ...
        print(f"📊 Generated {len(cycles)} cycles covering last year")
